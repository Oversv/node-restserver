...
app.get('/usuario', function (req, res) {  
    ...
    Usuario.find({estado: true}, 'nombre email role estado google rol img')
            .skip(desde)
            .limit(limite)
            .exec((err, usuarios) =>{
...
app.post('/usuario', function (req, res) {
    ...
    //Se crea una instancia del model/usuario y le pasamos los datos
    ...
    //Para grabar los datos en la DB
...
app.put('/usuario/:id', function (req, res) {
    ...
    //Documentación del método https://mongoosejs.com/docs/api.html#model_Model.findByIdAndUpdate
